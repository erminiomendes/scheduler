...
export function getAppointmentsForDay(state, day) {
  ...
  todayAppointment && todayAppointment.map((app => appointmentsArray.push(appointments[app])));// se tiver appointments, salvo no array
...
export function getInterview (state, interview) {  
  ...
  if (interviewer) {// Checando se interviewer esta na lista de interviewers
    result = ({
      ...interview,
      interviewer: {
        id: interviewer.id,
